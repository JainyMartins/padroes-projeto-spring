...
public class ClienteServiceImpl implements ClienteService {
    ...
    //Em vez de usar iterable poderia também ter criado uma lista de clientes para esse método
    @Override
    ...
    public Cliente buscarPorId(Long id) {
        ...
        //Retorna Optional porque PODE OU NÃO EXISTIR se não tiver regra caso cliente não exista
    ...
    //Esse método evita o reuso quando for salvar de novo no atualizar
